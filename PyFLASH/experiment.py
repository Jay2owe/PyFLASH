...
def _standardize_csv_columns_legacy(df):
    ...
    # Normalize numeric week identifiers (e.g. "Week2" → "WeekTwo") so that
    # ROI Intensities CSVs match the written-out names used by Objects and
    # Attributes CSVs.  replace_week_int is a no-op on already-normalized
    # names, so this is safe for all CSV formats.
